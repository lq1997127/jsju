...
public interface IConstructionDao {
	...
	// 保存一条记录
	public abstract void save(Construction construction);

	// 保存一条记录
	public abstract Integer savereturn(Construction construction);
	...
	// 根据hql语句来查询所有记录
	public abstract List<Construction> queryList(String queryString);

	// 根据hql、条件值查询某些记录
	public abstract List<Construction> getObjectsByCondition(String queryString,
			Object[] p);
	...
	// 根据hql、id列表查询某些记录
	public abstract List<Construction> getObjectsByIdList(final String hql,
			final List<Integer> idList);

	// 根据hql语句、条件值、分页查询某些记录
	public abstract List<Construction> pageList(final String queryString,
	...
	// 根据hql语句、条件、值来查询一条记录
	public abstract Construction queryByNamedParam(String queryString,
			String[] paramNames, Object[] values);
